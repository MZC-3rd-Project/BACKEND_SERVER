...
include(":libs:clients:pofile-client")
include(":libs:clients:stock-client")
include(":libs:clients:auth-client")
include(":libs:clients:order-client")
...
include(":libs:config:logging")
include(":libs:config:metrics")
...
include("servers:services:store")
