...
public class BusinessGatewaySecurityConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "gateway.dev-login", name = "enabled", havingValue = "true")
    public MapReactiveUserDetailsService devLoginUserDetailsService(BusinessGatewayDevLoginProperties properties) {
