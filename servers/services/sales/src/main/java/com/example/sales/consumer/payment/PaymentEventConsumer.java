...
@Component
@RoutedEventConsumer(
        consumerName = SalesPaymentEventProcessor.CONSUMER_NAME,
...
public class PaymentEventConsumer extends AbstractProcessorRoutingConsumer {
    ...
    public PaymentEventConsumer(
            ...
            SalesPaymentEventProcessor salesPaymentEventProcessor
    ) {
        super(inboxRoutingSupport, salesPaymentEventProcessor);
    }
