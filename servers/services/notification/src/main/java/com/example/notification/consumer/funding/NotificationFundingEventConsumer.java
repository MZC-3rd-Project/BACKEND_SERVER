...
@Component
@RoutedEventConsumer(
        consumerName = NotificationFundingEventProcessor.CONSUMER_NAME,
        defaultMode = ConsumerRoutingMode.INBOX
)
public class NotificationFundingEventConsumer extends AbstractProcessorRoutingConsumer {

    public NotificationFundingEventConsumer(
            InboxRoutingSupport inboxRoutingSupport,
            NotificationFundingEventProcessor notificationFundingEventProcessor
    ) {
        super(inboxRoutingSupport, notificationFundingEventProcessor);
    }
