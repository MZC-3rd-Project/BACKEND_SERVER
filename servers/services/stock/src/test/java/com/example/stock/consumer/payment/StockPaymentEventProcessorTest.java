...
class StockPaymentEventProcessorTest {
    ...
    @Test
    void process_paymentCompleted_confirmsReservation() {
        String message = """
        ...
        verify(stockCommandService).confirmReservationById(11L);
    }

    @Test
    void process_missingReservationId_skipsProcessing() {
        String message = """
    ...
    void process_invalidEnvelope_skipsProcessing() {
        String message = """
                {"eventType":"PAYMENT_COMPLETED","reservationId":11,"userId":33}
                """;
