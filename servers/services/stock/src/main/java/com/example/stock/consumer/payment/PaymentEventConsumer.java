...
@Component
@RoutedEventConsumer(
        consumerName = StockPaymentEventProcessor.CONSUMER_NAME,
...
public class PaymentEventConsumer extends AbstractProcessorRoutingConsumer {
    ...
    public PaymentEventConsumer(
            ...
            StockPaymentEventProcessor stockPaymentEventProcessor
    ) {
        super(inboxRoutingSupport, stockPaymentEventProcessor);
    }
